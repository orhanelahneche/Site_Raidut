...
Le parcours sportif propose deux variantes : <br/> <ul><li>En vélo, auquel cas les participants ne sont pas chronométrés</li><li>A pied, auquel cas les participants sont chronométrés</li></ul><br/>Le parcours loisir peut se faire à pied, ou en vélo. Dans les deux cas, ce parcours n’est pas chronométré.</p></div>} />
        <Accordion question={"A quelle heure se font les différents départs du raid ?"} response={<ul><li>Parcours Loisir : Départ entre 13h30 et 15h30</li><li>Parcours Intermédiaire : Départ entre 11h30 et 13h30</li><li>Parcours Compétition : Départ entre 9h et 10h30</li></ul>} />
        ...
        <Accordion question={"Où puis-je m’inscrire pour participer au Raid?"} response={<p>Pour participer au Raid, rien de plus simple ! Le lien de la billetterie est disponible sur le site. Assure toi de bien lire le règlement et de choisir le bon parcours et le bon tarif (Cotisant/Non cotisant BDE UTC).</p>} />
